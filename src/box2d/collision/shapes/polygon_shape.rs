...
extern "C" {
    ...
    fn b2PolygonShape_SetAsBox_Oriented(
...
impl Shape for PolygonShape {
    ...
    fn handle(&self) -> *mut B2Shape {
        unsafe { b2PolygonShape_Upcast(self.ptr) }
    }
}
...
impl PolygonShape {
    ...
    pub fn get_vertex(&self, index: i32) -> &Vec2 {
        unsafe { b2PolygonShape_GetVertex(&*self.ptr, index) }
    }

    /// Get the vertex count.
    pub fn get_vertex_count(&self) -> i32 {
        unsafe { b2PolygonShape_GetVertexCount(self.ptr) }
    }
